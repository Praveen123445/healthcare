...
const AppointmentForm = ({
  ...
  userId: string;
  patientId?: string;  // Updated type to handle undefined
  ...
  async function onSubmit(values: z.infer<typeof AppointmentFormValidation>) {
    ...
    try {
      const appointmentData: {
        ...
        userId,
        patient: type === 'create' && patientId ? patientId : undefined,
        primaryPhysician: values.primaryPhysician,
        schedule: new Date(values.schedule),
        reason: type === 'cancel' ? values.cancellationReason : values.reason,
        note: values.note,
        status,
      };
